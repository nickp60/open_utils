...
changed:
-group reassign in path area  
added coord_cartesian() for zooming out
"
...
#    coord_cartesian(c(-4,4), c(-4,4))
  ...
  return(base+coord_cartesian(c(-coord_scale,coord_scale),
                              c(-coord_scale,coord_scale)))
