...
def get_args():
    parser = argparse.ArgumentParser(
        ...
        "returning the hits that meet a se tof criteria. ",
        add_help=False)
    parser.add_argument(
        "ref_gb",
...
if __name__ == "__main__":
    ...
    if len(query_gb) > 1:
        raise ValueError("Multiple genbank files found in prokka ouput!")
    if reciprocal
